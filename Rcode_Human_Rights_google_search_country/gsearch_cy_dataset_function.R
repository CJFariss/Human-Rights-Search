...
out_dat <- gsearch_cy_dataset_function(cy_data_list=location_data, global_data_list=global_data)
cy_dat <- do.call("rbind", out_dat)
write.csv(cy_dat, paste("Data_output_search_cy_datasets/gsearch_cy_data_", gsub(" ", "_", "Amnesty International"), "_", gsub(" ", "_", "2015-01-01 2019-12-31"), "_saved_", current_date, ".csv", sep=""), row.names=FALSE)
