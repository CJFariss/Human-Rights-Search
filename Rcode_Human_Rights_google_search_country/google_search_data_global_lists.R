...
for(j in 1:length(TIME)){
  ...
  saveRDS(out_dat, paste("Data_output_global_search_lists/gsearch_global_data_lists_", gsub(" ", "_", TERMS[i]), "_", gsub(" ", "_", TIME[j]), "_saved_", current_date, ".RDS", sep=""))
...
for(j in 1:length(TIME)){
  ...
  ## save data.frame for future analysis 
  saveRDS(out_dat, paste("Data_output_global_search_lists/gsearch_global_data_lists_", gsub(" ", "_", "huquq_alansan"), "_", gsub(" ", "_", TIME[j]), "_saved_", current_date, ".RDS", sep=""))
