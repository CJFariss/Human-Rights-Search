## google_search_cy_analysis_NGO_interaction.R
##########################################################################
##
...
for(j in 1:4){
  ...
  if(attention_rate==FALSE & NGO_amnesty==TRUE) LABELS <- c("FDI Inflows", "Amnesty Reports (Count)", "HR Treaty Ratifications", "GDP Growth", "HR Violations", "Internet Censorship", "Spanish (derechos humanos)", "Portuguese (direitos humanos)", "French (droit)", "English (human rights)", "Arabic (huquq al-insan)", "Amnesty Reports * HR Violations")
  
  if(attention_rate==TRUE & NGO_amnesty==TRUE) LABELS <- c("FDI Inflows", "Amnesty Reports (Rate)", "HR Treaty Ratifications", "GDP Growth", "HR Violations", "Internet Censorship", "Spanish (derechos humanos)", "Portuguese (direitos humanos)", "French (droit)", "English (human rights)", "Arabic (huquq al-insan)", "Amnesty Reports * HR Violations")
  
  if(attention_rate==FALSE & NGO_amnesty==FALSE) LABELS <- c("FDI Inflows", "NGO Presence (Count)", "HR Treaty Ratifications", "GDP Growth", "HR Violations", "Internet Censorship", "Spanish (derechos humanos)", "Portuguese (direitos humanos)", "French (droit)", "English (human rights)", "Arabic (huquq al-insan)", "NGO Presence * HR Violations")
  
  if(attention_rate==TRUE & NGO_amnesty==FALSE) LABELS <- c("FDI Inflows", "NGO Presence (Rate)", "HR Treaty Ratifications", "GDP Growth", "HR Violations", "Internet Censorship", "Spanish (derechos humanos)", "Portuguese (direitos humanos)", "French (droit)", "English (human rights)", "Arabic (huquq al-insan)", "NGO Presence * HR Violations")
  ...
  if(j==3 & lowsearch_option==FALSE & attention_rate==FALSE & NGO_amnesty==TRUE) write(tab_output, file="Tex_tables/main_results_lowsearch_amnesty_report_count_2014_2018_NGO_interaction.tex")
  if(j==4 & lowsearch_option==FALSE & attention_rate==FALSE & NGO_amnesty==TRUE) write(tab_output, file="Tex_tables/main_results_lowsearch_amnesty_report_count_2015_2019_NGO_interaction.tex")
  
  if(j==1 & lowsearch_option==FALSE & attention_rate==TRUE & NGO_amnesty==TRUE) write(tab_output, file="Tex_tables/main_results_lowsearch_amnesty_report_rate_2012_2016_NGO_interaction.tex")
  if(j==2 & lowsearch_option==FALSE & attention_rate==TRUE & NGO_amnesty==TRUE) write(tab_output, file="Tex_tables/main_results_lowsearch_amnesty_report_rate_2013_2017_NGO_interaction.tex")
  if(j==3 & lowsearch_option==FALSE & attention_rate==TRUE & NGO_amnesty==TRUE) write(tab_output, file="Tex_tables/main_results_lowsearch_amnesty_report_rate_2014_2018_NGO_interaction.tex")
  if(j==4 & lowsearch_option==FALSE & attention_rate==TRUE & NGO_amnesty==TRUE) write(tab_output, file="Tex_tables/main_results_lowsearch_amnesty_report_rate_2015_2019_NGO_interaction.tex")
}


## save coefficient plots
for(j in 1:4){
  coef_mean <- fit_mean_robust[[j]][c(12,6:1),1]
  coef_median <- fit_median_robust[[j]][c(12,6:1),1]
  coef_max <- fit_max_robust[[j]][c(12,6:1),1]
  
  ## select value for first interval
  VALUE <- 1
  VALUE <- qt(.95, unit_n[j])
  
  coef_mean_1ub <- fit_mean_robust[[j]][c(12,6:1),1] + VALUE*fit_mean_robust[[j]][c(12,6:1),2]
  coef_median_1ub <- fit_median_robust[[j]][c(12,6:1),1] + VALUE*fit_mean_robust[[j]][c(12,6:1),2]
  coef_max_1ub <- fit_max_robust[[j]][c(12,6:1),1] + VALUE*fit_mean_robust[[j]][c(12,6:1),2]
  coef_mean_1lb <- fit_mean_robust[[j]][c(12,6:1),1] - VALUE*fit_mean_robust[[j]][c(12,6:1),2]
  coef_median_1lb <- fit_median_robust[[j]][c(12,6:1),1] - VALUE*fit_mean_robust[[j]][c(12,6:1),2]
  coef_max_1lb <- fit_max_robust[[j]][c(12,6:1),1] - VALUE*fit_mean_robust[[j]][c(12,6:1),2]
  
  ## select value for second interval
  VALUE <- 2
  VALUE <- qt(.975, unit_n[j])
  
  coef_mean_2ub <- fit_mean_robust[[j]][c(12,6:1),1] + VALUE*fit_mean_robust[[j]][c(12,6:1),2]
  coef_median_2ub <- fit_median_robust[[j]][c(12,6:1),1] + VALUE*fit_mean_robust[[j]][c(12,6:1),2]
  coef_max_2ub <- fit_max_robust[[j]][c(12,6:1),1] + VALUE*fit_mean_robust[[j]][c(12,6:1),2]
  coef_mean_2lb <- fit_mean_robust[[j]][c(12,6:1),1] - VALUE*fit_mean_robust[[j]][c(12,6:1),2]
  coef_median_2lb <- fit_median_robust[[j]][c(12,6:1),1] - VALUE*fit_mean_robust[[j]][c(12,6:1),2]
  coef_max_2lb <- fit_max_robust[[j]][c(12,6:1),1] - VALUE*fit_mean_robust[[j]][c(12,6:1),2]
  
  ## select value for third *optional) interval
  VALUE <- 3
  VALUE <- qt(.995, unit_n[j])
  
  coef_mean_3ub <- fit_mean_robust[[j]][c(12,6:1),1] + VALUE*fit_mean_robust[[j]][c(12,6:1),2]
  coef_median_3ub <- fit_median_robust[[j]][c(12,6:1),1] + VALUE*fit_mean_robust[[j]][c(12,6:1),2]
  coef_max_3ub <- fit_max_robust[[j]][c(12,6:1),1] + VALUE*fit_mean_robust[[j]][c(12,6:1),2]
  coef_mean_3lb <- fit_mean_robust[[j]][c(12,6:1),1] - VALUE*fit_mean_robust[[j]][c(12,6:1),2]
  coef_median_3lb <- fit_median_robust[[j]][c(12,6:1),1] - VALUE*fit_mean_robust[[j]][c(12,6:1),2]
  coef_max_3lb <- fit_max_robust[[j]][c(12,6:1),1] - VALUE*fit_mean_robust[[j]][c(12,6:1),2]
  
  cbind(coef_mean, coef_median, coef_max)
  
  ## coefficient plots
  ## create graph file
  if(j==1 & lowsearch_option==FALSE & attention_rate==FALSE & NGO_amnesty==TRUE) pdf("Rplots_coefplots/coefs_lowsearch_amnesty_amnesty_report_count_2012_2016_NGO_interaction_Rplot.pdf", height=6, width=8)
  if(j==2 & lowsearch_option==FALSE & attention_rate==FALSE & NGO_amnesty==TRUE) pdf("Rplots_coefplots/coefs_lowsearch_amnesty_amnesty_report_count_2013_2017_NGO_interaction_Rplot.pdf", height=6, width=8)
  if(j==3 & lowsearch_option==FALSE & attention_rate==FALSE & NGO_amnesty==TRUE) pdf("Rplots_coefplots/coefs_lowsearch_amnesty_amnesty_report_count_2014_2018_NGO_interaction_Rplot.pdf", height=6, width=8)
  if(j==4 & lowsearch_option==FALSE & attention_rate==FALSE & NGO_amnesty==TRUE) pdf("Rplots_coefplots/coefs_lowsearch_amnesty_amnesty_report_count_2015_2019_NGO_interaction_Rplot.pdf", height=6, width=8)
  
  if(j==1 & lowsearch_option==FALSE & attention_rate==TRUE & NGO_amnesty==TRUE) pdf("Rplots_coefplots/coefs_lowsearch_amnesty_amnesty_report_rate_2012_2016_NGO_interaction_Rplot.pdf", height=6, width=8)
  if(j==2 & lowsearch_option==FALSE & attention_rate==TRUE & NGO_amnesty==TRUE) pdf("Rplots_coefplots/coefs_lowsearch_amnesty_amnesty_report_rate_2013_2017_NGO_interaction_Rplot.pdf", height=6, width=8)
  if(j==3 & lowsearch_option==FALSE & attention_rate==TRUE & NGO_amnesty==TRUE) pdf("Rplots_coefplots/coefs_lowsearch_amnesty_amnesty_report_rate_2014_2018_NGO_interaction_Rplot.pdf", height=6, width=8)
  if(j==4 & lowsearch_option==FALSE & attention_rate==TRUE & NGO_amnesty==TRUE) pdf("Rplots_coefplots/coefs_lowsearch_amnesty_amnesty_report_rate_2015_2019_NGO_interaction_Rplot.pdf", height=6, width=8)
  ...
  if(attention_rate==FALSE & NGO_amnesty==FALSE) axis(side=2, at=c(7,6:1), labels=c("FDI Inflows", "NGO Presence (Count)", "HR Treaty Ratifications", "GDP Growth", "HR Violations", "Internet Censorship", "NGO Presence * HR Violations"), las=2)
