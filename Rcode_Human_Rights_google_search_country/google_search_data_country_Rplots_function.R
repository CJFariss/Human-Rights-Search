...
google_search_data_country_Rplot_function <- function(dat_list, file_name="temp.pdf"){
  ...
  #par(mfrow=c(2,3), mar=c(2,2.5,1,.5))
...
#google_search_data_country_Rplot_function(dat_list=out_dat, file_name=paste("Rplots_country_search_ranks/", gsub(" ", "_", "human rights"), "_country_week_time_series_lowsearch_", gsub(" ", "_", "2015-01-01 2019-12-31"), "_wide_small.pdf", sep=""))
...
#google_search_data_country_Rplot_function(dat_list=out_dat, file_name=paste("Rplots_country_search_ranks/", gsub(" ", "_", "derechos humanos"), "_country_week_time_series_lowsearch_", gsub(" ", "_", "2015-01-01 2019-12-31"), "_wide_small.pdf", sep=""))
