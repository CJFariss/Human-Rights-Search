## google_search_cy_analysis_excludeUS.R
##########################################################################
##
...
for(j in 1:4){
  ...
  if(j==1 & lowsearch_option==FALSE & attention_rate==FALSE & NGO_amnesty==TRUE) write(tab_output, file="Tex_tables/main_results_lowsearch_amnesty_report_count_excludeUS_2012_2016.tex")
  if(j==2 & lowsearch_option==FALSE & attention_rate==FALSE & NGO_amnesty==TRUE) write(tab_output, file="Tex_tables/main_results_lowsearch_amnesty_report_count_excludeUS_2013_2017.tex")
  if(j==3 & lowsearch_option==FALSE & attention_rate==FALSE & NGO_amnesty==TRUE) write(tab_output, file="Tex_tables/main_results_lowsearch_amnesty_report_count_excludeUS_2014_2018.tex")
  if(j==4 & lowsearch_option==FALSE & attention_rate==FALSE & NGO_amnesty==TRUE) write(tab_output, file="Tex_tables/main_results_lowsearch_amnesty_report_count_excludeUS_2015_2019.tex")
  
  if(j==1 & lowsearch_option==FALSE & attention_rate==TRUE & NGO_amnesty==TRUE) write(tab_output, file="Tex_tables/main_results_lowsearch_amnesty_report_rate_excludeUS_2012_2016.tex")
  if(j==2 & lowsearch_option==FALSE & attention_rate==TRUE & NGO_amnesty==TRUE) write(tab_output, file="Tex_tables/main_results_lowsearch_amnesty_report_rate_excludeUS_2013_2017.tex")
  if(j==3 & lowsearch_option==FALSE & attention_rate==TRUE & NGO_amnesty==TRUE) write(tab_output, file="Tex_tables/main_results_lowsearch_amnesty_report_rate_excludeUS_2014_2018.tex")
  if(j==4 & lowsearch_option==FALSE & attention_rate==TRUE & NGO_amnesty==TRUE) write(tab_output, file="Tex_tables/main_results_lowsearch_amnesty_report_rate_excludeUS_2015_2019.tex")
}
...
for(j in 1:4){
  ...
  ## coefficient plots
  ## create graph file
  if(j==1 & lowsearch_option==FALSE & attention_rate==FALSE & NGO_amnesty==TRUE) pdf("Rplots_coefplots/coefs_lowsearch_amnesty_amnesty_report_count_excludeUS_2012_2016_Rplot.pdf", height=6, width=8)
  if(j==2 & lowsearch_option==FALSE & attention_rate==FALSE & NGO_amnesty==TRUE) pdf("Rplots_coefplots/coefs_lowsearch_amnesty_amnesty_report_count_excludeUS_2013_2017_Rplot.pdf", height=6, width=8)
  if(j==3 & lowsearch_option==FALSE & attention_rate==FALSE & NGO_amnesty==TRUE) pdf("Rplots_coefplots/coefs_lowsearch_amnesty_amnesty_report_count_excludeUS_2014_2018_Rplot.pdf", height=6, width=8)
  if(j==4 & lowsearch_option==FALSE & attention_rate==FALSE & NGO_amnesty==TRUE) pdf("Rplots_coefplots/coefs_lowsearch_amnesty_amnesty_report_count_excludeUS_2015_2019_Rplot.pdf", height=6, width=8)
  
  if(j==1 & lowsearch_option==FALSE & attention_rate==TRUE & NGO_amnesty==TRUE) pdf("Rplots_coefplots/coefs_lowsearch_amnesty_amnesty_report_rate_excludeUS_2012_2016_Rplot.pdf", height=6, width=8)
  if(j==2 & lowsearch_option==FALSE & attention_rate==TRUE & NGO_amnesty==TRUE) pdf("Rplots_coefplots/coefs_lowsearch_amnesty_amnesty_report_rate_excludeUS_2013_2017_Rplot.pdf", height=6, width=8)
  if(j==3 & lowsearch_option==FALSE & attention_rate==TRUE & NGO_amnesty==TRUE) pdf("Rplots_coefplots/coefs_lowsearch_amnesty_amnesty_report_rate_excludeUS_2014_2018_Rplot.pdf", height=6, width=8)
  if(j==4 & lowsearch_option==FALSE & attention_rate==TRUE & NGO_amnesty==TRUE) pdf("Rplots_coefplots/coefs_lowsearch_amnesty_amnesty_report_rate_excludeUS_2015_2019_Rplot.pdf", height=6, width=8)
