## google_search_cy_analysis_NGO_alt.R
##########################################################################
##
...
for(j in 1:4){
  ...
  if(attention_rate==TRUE & NGO_amnesty==FALSE) LABELS <- c("FDI Inflows", "Amnesty Reports (Rate)", "HR Treaty Ratifications", "GDP Growth", "HR Violations", "Internet Censorship", "Spanish (derechos humanos)", "Portuguese (direitos humanos)", "French (droit)", "English (human rights)", "Arabic (huquq al-insan)")
  ...
  if(j==2 & lowsearch_option==FALSE & attention_rate==FALSE & NGO_amnesty==FALSE) write(tab_output, file="Tex_tables/main_results_lowsearch_NGO_count_2013_2017.tex")
  if(j==3 & lowsearch_option==FALSE & attention_rate==FALSE & NGO_amnesty==FALSE) write(tab_output, file="Tex_tables/main_results_lowsearch_NGO_count_2014_2018.tex")
  if(j==4 & lowsearch_option==FALSE & attention_rate==FALSE & NGO_amnesty==FALSE) write(tab_output, file="Tex_tables/main_results_lowsearch_NGO_count_2015_2019.tex")
  
  if(j==1 & lowsearch_option==FALSE & attention_rate==TRUE & NGO_amnesty==FALSE) write(tab_output, file="Tex_tables/main_results_lowsearch_NGO_rate_2012_2016.tex")
  if(j==2 & lowsearch_option==FALSE & attention_rate==TRUE & NGO_amnesty==FALSE) write(tab_output, file="Tex_tables/main_results_lowsearch_NGO_rate_2013_2017.tex")
  if(j==3 & lowsearch_option==FALSE & attention_rate==TRUE & NGO_amnesty==FALSE) write(tab_output, file="Tex_tables/main_results_lowsearch_NGO_rate_2014_2018.tex")
  if(j==4 & lowsearch_option==FALSE & attention_rate==TRUE & NGO_amnesty==FALSE) write(tab_output, file="Tex_tables/main_results_lowsearch_NGO_rate_2015_2019.tex")
}
...
for(j in 1:4){
  ...
  ## coefficient plots
  ## create graph file
  if(j==1 & lowsearch_option==FALSE & attention_rate==FALSE & NGO_amnesty==FALSE) pdf("Rplots_coefplots/coefs_lowsearch_NGO_count_2012_2016_Rplot.pdf", height=6, width=8)
  if(j==2 & lowsearch_option==FALSE & attention_rate==FALSE & NGO_amnesty==FALSE) pdf("Rplots_coefplots/coefs_lowsearch_NGO_count_2013_2017_Rplot.pdf", height=6, width=8)
  if(j==3 & lowsearch_option==FALSE & attention_rate==FALSE & NGO_amnesty==FALSE) pdf("Rplots_coefplots/coefs_lowsearch_NGO_count_2014_2018_Rplot.pdf", height=6, width=8)
  if(j==4 & lowsearch_option==FALSE & attention_rate==FALSE & NGO_amnesty==FALSE) pdf("Rplots_coefplots/coefs_lowsearch_NGO_count_2015_2019_Rplot.pdf", height=6, width=8)
  
  if(j==1 & lowsearch_option==FALSE & attention_rate==TRUE & NGO_amnesty==FALSE) pdf("Rplots_coefplots/coefs_lowsearch_NGO_rate_2012_2016_Rplot.pdf", height=6, width=8)
  if(j==2 & lowsearch_option==FALSE & attention_rate==TRUE & NGO_amnesty==FALSE) pdf("Rplots_coefplots/coefs_lowsearch_NGO_rate_2013_2017_Rplot.pdf", height=6, width=8)
  if(j==3 & lowsearch_option==FALSE & attention_rate==TRUE & NGO_amnesty==FALSE) pdf("Rplots_coefplots/coefs_lowsearch_NGO_rate_2014_2018_Rplot.pdf", height=6, width=8)
  if(j==4 & lowsearch_option==FALSE & attention_rate==TRUE & NGO_amnesty==FALSE) pdf("Rplots_coefplots/coefs_lowsearch_NGO_rate_2015_2019_Rplot.pdf", height=6, width=8)
