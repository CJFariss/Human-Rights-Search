## google_search_cy_analysis_merges.R
##########################################################################
##
...
##########################################################################
## Amnesty International lowsearch merge
##########################################################################

files_names <- list.files("Data_output_search_cy_datasets_lowsearch_AI")
files_names

dat_list <- list()
for(i in 1:length(files_names)){
  dat_list[[i]] <- read.csv(paste("Data_output_search_cy_datasets_lowsearch_AI/",files_names[i], sep=""))
}
length(dat_list)
...
## saved combined list of datasets
saveRDS(dat_list_merged, file="Data_output/combined_gsearch_dat_list_merged_lowsearch_AI.RDS")
