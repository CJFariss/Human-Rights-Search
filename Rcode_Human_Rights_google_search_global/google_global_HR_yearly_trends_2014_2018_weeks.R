## google_global_HR_yearly_trends_2014_2018_weeks.R
##########################################################################
##
...
write.csv(dat, paste("Data_output/Google_search_world_2014_2018_weekly_", current_date, ".csv", sep=""), row.names=FALSE)
