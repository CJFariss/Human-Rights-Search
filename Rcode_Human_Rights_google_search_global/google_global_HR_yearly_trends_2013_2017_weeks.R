## google_global_HR_yearly_trends_2013_2017_months.R
##########################################################################
##
...
pdf("Rplots/Global_search_hits_mean_CI_2013_2017.pdf", height=6, width=6)
...
write.csv(dat, paste("Data_output/Google_search_world_2013_2017_weekly_", current_date, ".csv", sep=""), row.names=FALSE)
