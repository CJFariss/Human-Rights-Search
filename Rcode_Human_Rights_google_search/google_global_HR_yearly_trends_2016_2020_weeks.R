## google_global_HR_yearly_trends_2016_2020_months.R
##########################################################################
##
...
pdf("Rplots/Global_search_hits_mean_CI_2016_2020.pdf", height=6, width=6)
...
for(i in 1:length(TERMS)){
    ...
    axis(side=1, at=c(median(id2016), median(id2017), median(id2018), median(id2019), median(id2020)), labels=c(2016, 2017, 2018, 2019, 2020), las=1)
...
write.csv(dat, paste("Data_output/Google_search_world_2016_2020_weekly_", current_date, ".csv", sep=""), row.names=FALSE)
